    ...
    ***********************************-->
    <div class="nav-header">
        <a href="{{route('admin.dashboard')}}" class="brand-logo">
            ...
            <img src="{{my_asset(get_setting()->favicon)}}" alt="logo" class="logo-abbr me-2" height="30" width="32">

            <span class="brand-title" width="111" height="24" >{{get_setting('name')}}</span>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell dz-theme-mode" href="javascript:void(0);">
                                    <svg id="icon-light" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <svg id="icon-dark" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                        viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                                            <path
                            ...
                            {{-- notifications --}}
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" id="notificationDropdown">
                                    ...
                                    <span class="badge bg-danger rounded-circle noti-icon-badge notif-counts"></span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-2" style="max-height:380px;">
                                        <ul class="timeline" id="topnotif-list">
                                    ...
                                    <a class="all-notification" href="{{route('admin.notifications')}}">See all notifications <i class="ti-arrow-end"></i></a>
                                </div>
                            </li>
                            {{-- Profile --}}
                                    ...
                                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="header-info2 d-flex align-items-center">
                                            <div class="header-media">
                                                <img src="{{static_asset('admin/images/user.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <div class="card border-0 mb-0">
                                            <div class="card-header py-2">
                                                <div class="products">
                                                    <img src="{{static_asset('admin/images/user.jpg')}}" class="avatar avatar-md" alt="">
                                                    <div>
                                                        <h6>{{Auth('admin')->user()->name}}</h6>
                                                        <span>{{ucfirst(Auth('admin')->user()->role)}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <a href="{{route('admin.profile')}}" class="dropdown-item ai-icon ">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            stroke="var(--primary)" stroke-width="1.42857" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                            ...
                                            <div class="card-footer px-0 py-2">
                                                <a href="{{route('admin.settings.index')}}" class="dropdown-item ai-icon ">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            stroke="var(--primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                        <circle cx="12.175" cy="11.889" r="2.63616" stroke="var(--primary)" stroke-width="1.5"
                                                ...
                                                <a href="{{route('admin.logout')}}" class="dropdown-item ai-icon">
                                                    <svg class="logout-svg" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
